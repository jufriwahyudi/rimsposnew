            ...
            <div class="login-card text-start">
                ...
                <form method="POST" action="{{ route('peserta.login.submit') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="registrasi" type="text" name="registrasi" value="{{ old('registrasi') }}"
                            class="form-control @error('registrasi') is-invalid @enderror"
                            placeholder="Masukkan nomor registrasi anda" required autofocus>
                        @error('registrasi')
                    ...
                    <div class="mb-3">
                        ...
                        <input id="password" type="date" name="password"
