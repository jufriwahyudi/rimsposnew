...
@section('title', 'Laporan Penjualan NSE')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="#"><i class="bx bx-home-alt"></i> Laporan Penjualan NSE</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        $(function() {
            ...
            $('#searchBtn').click(function() {
                ...
                $.ajax({
                    url: "{{ route('laporanpenjualanNSE.getpenjualanNSE') }}",
                    type: "POST",
                    data: {
    ...
    <script>
        // Handle filter divisi
        $(document).on('click', '#btnFilter', function() {
            var datefilter = $('#datefilter').val();
            var id_divisi = $('#filterDivisi').val();
            ...
            // AJAX request ke controller dengan filter divisi
            $.ajax({
                url: "{{ route('laporanpenjualanNSE.getpenjualanNSE') }}",
                type: "POST",
                data: {
