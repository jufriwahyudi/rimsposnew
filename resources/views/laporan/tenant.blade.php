...
@section('title', 'Laporan Piutang Tenant')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="#"><i class="bx bx-home-alt"></i> Laporan Piutang Tenant</a></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="card rounded-4 p-2">
                    <div class="card-header d-flex justify-content-between align-items-center mb-3 flex-wrap">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h5 class="fw-bold mb-0" style="color: #7c3aed">Laporan Piutang / Settlement Tenant</h5>
